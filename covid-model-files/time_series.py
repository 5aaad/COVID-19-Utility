...
# %cd /content/gdrive/My Drive/timeSeries


df0 = pd.read_csv("C:/Users/Saad Ur Rehman/Desktop/COVID19/covid-model-files/CONVENIENT_global_confirmed_cases (1).csv")


df1 = pd.read_csv("C:/Users/Saad Ur Rehman/Desktop/COVID19/covid-model-files/CONVENIENT_global_deaths.csv")
...
continent=pd.read_csv("C:/Users/Saad Ur Rehman/Desktop/COVID19/covid-model-files/continents2.csv")
...
class Fbprophet(object):
    def fit(self,data):
        ...
        self.model.fit(self.data, verbose=False)
...
forecast["yhat"].plot(marker=".",figsize=(15,5))
