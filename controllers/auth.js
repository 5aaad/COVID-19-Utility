 ...
 exports.register = asyncHandler(async (req, res, next) => {
 	...
 	sendTokenResponse(patient, 200, res.redirect('/home'));
 ...
 exports.updateDetails = asyncHandler(async (req, res, next) => {
 	const savedPatient = await Patient.findById(req.patient.id);

 	// console.log(req.body)
 	const fieldsToUpdate = {
 		isPreviouslyDiagnosed: savedPatient.isPreviouslyDiagnosed,
 		role: savedPatient.role,
 		amount: savedPatient.amount,
 		name: req.body.title || savedPatient.name,
 		email: req.body.email || savedPatient.email,
 		age: req.body.age || savedPatient.age,
 		bloodGroup: req.body.bloodGroup || savedPatient.bloodGroup,
 		address: req.body.address || savedPatient.address,
 		gender: req.body.gender || savedPatient.gender,
 		phoneNumber: req.body.phoneNumber || savedPatient.phoneNumber
 	}
 	...
 	res.status(200).redirect('/manageAccount');
 });
